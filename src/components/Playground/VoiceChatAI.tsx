...
const VoiceChatAI = () => {
    ...
    return <div className="flex px-2 justify-center items-center gap-4 ">
        ...
        {isListening ?
            (<div className="flex justify-center gap-2 items-center flex-row h-72 w-72 border dark:border-neutral-500 shadow-md rounded-2xl dark:bg-neutral-800 p-2 from-indigo-100 via-blue-100 bg-linear-to-br">
