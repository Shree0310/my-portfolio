            ...
            {currentCard && (
                <motion.div ref={ref} 
                    ...
                    <motion.p
                        ...
                        className="text-sm dark:text-neutral-400 text-neutral-600 px-4 flex items-center mt-6">
                        {currentCard.content()}
                    </motion.p>
                </motion.div>
            )}
                ...
                {cards.map((card,idx) => (
                    <motion.div key={card.title}
                        ...
                        <div className="flex flex-row items-center">
                            <motion.p layoutId={`card-des-${card.title}`} className="text-sm dark:text-neutral-300 text-neutral-600 px-4 flex items-center ">{card.description}</motion.p>
