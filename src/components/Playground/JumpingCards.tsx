...
const JumpingCards = () => {
    ...
    const cards = [
        {
            ...
            skeleton: (
                <div className='w-full h-30 bg-linear-to-r from-orange-700 to orange-700/50'></div>
            ),
        ...
        },
        {
            ...
            skeleton: (
                <div className='w-full h-30 bg-linear-to-r from-stone-500 to-stone-500/50'></div>
            ),
        ...
        },
        {
            ...
            skeleton: (
                <div className='w-full h-30 bg-linear-to-r from-sky-700 to-sky-700/50'></div>
            ),
        ...
        },
        {
            ...
            skeleton: (
                <div className='w-full h-30 bg-linear-to-r from-emerald-600 to-emerald-600/50'></div>
            ),
        ...
        },
        {
            ...
            skeleton: (
                <div className='w-full h-30 bg-linear-to-r from-stone-400 to-stone-400/50'></div>
            ),
    ...
    return <div ref={ref} className="max-w-5xl mx-auto w-full h-96 relative mt-16 ml-20">
        {cards.map((card,index) => (
            ...
            >
                <motion.button
                    ...
                    className={cn('w-80 font-signika absolute p-8 cursor-pointer inset-0 flex rounded-lg  flex-col items-start justify-between overflow-hidden', card.className )}>
                    {card.skeleton}
